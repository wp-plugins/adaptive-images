<?php
    ...
    if ( is_admin() ) {
        ...
        add_action( 'admin_head', 'adaptive_images_admin_echo_admin_css' );
        add_action( 'admin_head', 'adaptive_images_admin_echo_admin_js' );
    ...
    if ( ! is_admin() ) {
        ...
        add_action( 'wp_head', 'adaptive_images_front_echo_javascript_cookie', 0 );

        // Sets up the Javascript which adds a URL parameter to images for CDNs in the head element of the theme.

        add_action( 'wp_head', 'adaptive_images_front_echo_javascript_cdn_support', 0 );
