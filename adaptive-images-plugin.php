<?php
    ...
    /**
     * Checks whether the current page is the plugin settins page.
     * 
     * @author Nevma (info@nevma.gr)
     * 
     * @return boolean Whether the current page is the plugin settins page.
     */

    function adaptive_images_plugin_is_settings_screen () {
    	
        $screen = get_current_screen();

        return $screen->id == 'settings_page_adaptive-images';
    ...
    function adaptive_images_plugin_get_url () {

        return plugin_dir_url( dirname( __FILE__ ) . '/adaptive-images.php' );
    ...
    function adaptive_images_plugin_get_cache_directory_path () {
